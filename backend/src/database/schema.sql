-- Esquema PostgreSQL para BizRise
...
CREATE INDEX IF NOT EXISTS IX_Emprendimientos_verificacion ON Emprendimientos(estado_verificacion);
CREATE INDEX IF NOT EXISTS IX_Productos_emprendimiento ON Productos(id_emprendimiento);
CREATE INDEX IF NOT EXISTS IX_Ventas_usuario     ON Ventas(id_usuario);
CREATE INDEX IF NOT EXISTS IX_Ventas_emprendimiento ON Ventas(id_emprendimiento);
CREATE INDEX IF NOT EXISTS IX_Ventas_estado      ON Ventas(estado);
CREATE INDEX IF NOT EXISTS IX_Ventas_fecha       ON Ventas(fecha_creacion);
CREATE INDEX IF NOT EXISTS IX_Emp_Categoria ON Emprendimientos(id_categoria);
CREATE INDEX IF NOT EXISTS IX_Emp_Distrito  ON Emprendimientos(distrito);
CREATE INDEX IF NOT EXISTS IX_Val_Emp       ON Valoraciones(id_emprendimiento);
CREATE INDEX IF NOT EXISTS IX_Com_Emp       ON Comentarios(id_emprendimiento);
CREATE INDEX IF NOT EXISTS IX_Prom_Emp      ON Promociones(id_emprendimiento);
